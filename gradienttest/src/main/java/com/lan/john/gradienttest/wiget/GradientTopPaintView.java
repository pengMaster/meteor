...
public class GradientTopPaintView extends View {
    ...
    public GradientTopPaintView(Context context) {
        super(context);
    ...
    public GradientTopPaintView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public GradientTopPaintView(Context context, AttributeSet attrs, int defStyleAttr) {
